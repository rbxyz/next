...
import { index, pgTableCreator, text, timestamp, varchar, serial, pgEnum, uuid, primaryKey, foreignKey, boolean, } from "drizzle-orm/pg-core";
/**
...
export const workspaceMember = createTable("workspace_member", {
    userId: text("user_id")
        .notNull()
        .references(() => user.id),
